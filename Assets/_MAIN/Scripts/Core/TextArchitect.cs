...
public class TextArchitect
{
    ...
    public string fullTargetText => preText + targetText;
     ...
     {
         get { return tmpro.color; } set { tmpro.color = value; }
     }
     ...
     {
         return speed <= 2f ? characterMultiplier : speed <= 2.5f ? characterMultiplier * 2 :
     ...
     private void Prepare_Fade()
     {
         ...
         Color32[] vertexColors = textInfo.meshInfo[textInfo.characterInfo[0].materialReferenceIndex
         ].colors32;
     ...
     private IEnumerator Build_Fade()
     {
         ...
         while (true)
         {
             ...
             float fadeSpeed = (speed * (hurryUp ? charactersPerCycle * 5 : charactersPerCycle)) * 4f;
